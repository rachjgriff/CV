...
| ----- | ----- | ----- | ----- | ----- 
| [Guilt Tripper](https://github.com/rhysco8/greenpeas-uk) | Team project to build an eco-friendly app in the final 2 weeks of Makers.  We applied the process we learnt during the course to use a tech stack that we hadn't used before whilst maintaining Agile methods. The app checks products for palm oil and returns current news articles on this if the product contains it | 11 & 12 | 8 days | Swift, Xcode |
...
| [Bank Tech Test](https://github.com/rachjgriff/bank) | Individual project to print bank transactions in a specific bank statement format.  Although not perfect and further refactoring is required, this demonstrates my understanding of OOP and mocking. | 10 | 4 days | Ruby, RSpec, Rubocop, SimpleCov, Travis CI |
